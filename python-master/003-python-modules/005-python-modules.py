 ...
 * __all__ This is a special "directive"(a string "__all__") that is placed in  the __init__.py file, If this is done then when we import the module, Python loads all the modules to the memory.
 * __main__.py
 * __main__ 
 ...
 * Create a Folder in say `/Users/sravyamyla/Downloads/code/`
 ```
#mkdir /Users/sravyamyla/Downloads/code/Sravya
 ```
