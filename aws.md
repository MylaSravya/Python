...
The difference between EC2 and Amazon S3 is that
                      ...
                      EC2	                                                  S3
It is a cloud web service used for                             It is a data storage system where
hosting your application	                                    any amount of data can be stored
...
## 54) What are the features of Amazon Database?
...
## 55) What is a key-value store?
Key-value store is a database service that facilitates the storing, updating, and querying of the objects which are generally identified with the key and values. These objects consist of the keys and values which constitute the actual content that is stored.